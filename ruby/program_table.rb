$program_table = [
  ...
  127, ON, ON,      # FILTER CUTOFF, RESONANCE, ENVELOPE,
  0, 96, 96,        # EG ATTACK, DECAY/RELEASE, SUSTAIN
  ...
  127, OFF, ON,     # FILTER CUTOFF, RESONANCE, ENVELOPE,
  0, 96, 127,       # EG ATTACK, DECAY/RELEASE, SUSTAIN
  ...
  SAW, 64, 74,      # OSC2 WAVEFORM, COARSE TUNE, FINE TUNE,
  SAW, 64, 64,      # OSC3 WAVEFORM, COARSE TUNE, FINE TUNE,
  0, ON, ON,       # FILTER CUTOFF, RESONANCE, ENVELOPE,
