...
const uint8_t VCF_CUTOFF_FREQUENCY  = 48;
const uint8_t VCF_RESONANCE         = 49;
const uint8_t VCF_ENVELOPE_AMOUNT   = 50;
const uint8_t EG_ATTACK_TIME        = 51;
const uint8_t EG_DECAY_TIME         = 52;
const uint8_t EG_SUSTAIN_LEVEL      = 53;
